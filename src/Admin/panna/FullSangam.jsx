...
function FullSangam() {
    return (
        <AdminLayout>
            ...
            <div className="px-4 py-6 lg:px-10 lg:py-2.5">
                <div className="container mx-auto">
                    <div className="bg-white shadow-lg rounded-lg">
                        <div className="p-6">
                            <h4 className="text-lg font-semibold mb-4">Full Sangam Numbers</h4>
                            <h5 className="text-md font-medium mb-4">Open Ank</h5>

                            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-12 gap-2 mb-6 gap-2">
                                {[
                                    ...
                                    <button key={num} className="digit_num_box px-4 py-2 bg-gray-200 hover:bg-gray-300 text-sm font-semibold rounded-lg shadow">
                                        {num}
                                    </button>
                                ))}
                            </div>
