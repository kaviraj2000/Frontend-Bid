...
function AddSuccess({ user_id, fetchUserData }) {
    ...
    async function handleForms(e) {
        ...
        try {
            const response = await main.usersuccess(Regs);
    ...
    return (
        <>
            ...
            <Modal
                ...
                className="max-w-lg mx-auto bg-white rounded-lg shadow-lg outline-none"
